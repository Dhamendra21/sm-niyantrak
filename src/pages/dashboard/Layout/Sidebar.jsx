  ...
  return (
    <>
      ...
      {isMobileMenuOpen && (
        ...
        >
          <div 
            className="fixed left-0 top-0 bottom-0 w-64 bg-gradient-to-b from-gray-800 to-gray-900 text-white transform transition-transform duration-300 ease-in-out overflow-y-auto"
      ...
      <aside className="w-64 fixed inset-y-0 left-0 z-30 bg-gradient-to-b from-gray-800 to-gray-900 text-white flex-col hidden lg:flex">
        {/* Logo Section */}
        <Link to="/" className="flex cursor-pointer items-center gap-3 px-6 py-5 border-b border-gray-700/50 hover:bg-gray-700/50 transition-colors">
          <div className="h-10 w-10 bg-gradient-to-r from-green-500 to-blue-500 rounded-lg flex items-center justify-center text-white font-bold">
            SN
          </div>
          <div>
